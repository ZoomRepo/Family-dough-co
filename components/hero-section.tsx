  ...
  return (
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/rustic-artisan-sourdough-bread-on-wooden-table-wit.jpg" alt="Artisan sourdough bread" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl text-card/90 mb-8 max-w-2xl mx-auto leading-relaxed">
          Premium sourdough starters cultivated with care, tradition, and a passion for authentic artisan baking.
        </p>
